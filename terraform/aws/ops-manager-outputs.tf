locals {
  stable_config_opsmanager = {
    ...
    ops_manager_password                  = random_password.ops_manager_password.result

    dns_zone_name         = aws_route53_zone.hosted.name
    dns_zone_name_servers = aws_route53_zone.hosted.name_servers
